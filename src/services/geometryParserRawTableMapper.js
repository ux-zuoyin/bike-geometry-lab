...
const FIELD_ALIASES = Object.freeze([
  ["stack", ["车架堆高", "stack"]],
  ["reach", ["车架前伸量", "reach"]],
  ["seatTubeLength", ["尺寸座管长度", "座管长度", "立管长度", "seattubelength", "seattube"]],
  ["effectiveTopTube", ["上管长度水平", "水平上管长度", "有效上管", "effectivetoptube", "toptube"]],
  ["seatTubeAngle", ["座管角度", "立管角度", "seattubeangle"]],
  ["headTubeAngle", ["头管角度", "headtubeangle"]],
  ["headTubeLength", ["头管长度", "headtube"]],
  ["chainstay", ["后轮轴距", "后下叉长度", "chainstay"]],
  ["wheelbase", ["车轮轴距", "轮轴距", "轴距", "wheelbase"]],
  ["forkOffset", ["前叉调节量", "前叉偏移量", "前叉偏移", "前叉偏置", "forkoffset", "forkrake"]],
  ["bbDrop", ["中轴下沉量", "中轴下沉", "五通下沉", "bbdrop", "bottombracketdrop"]],
]);
