...
export function RoadBikeVisual({ data, project, preset, showFigmaAnchors = false }) {
  if (preset.id === "endurance") {
    return <EnduranceBikeTemplate data={data} project={project} showFigmaAnchors={showFigmaAnchors} />;
  }
